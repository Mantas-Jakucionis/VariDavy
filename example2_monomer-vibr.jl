...
### An example model of a molecule coupled to 1 intramolecular vibrational mode per molecule at 0 temperature. 
### Using D2 ansatz (nmultp = 1)
input = Example_Model(
                    ...
                    iwE = [500.0;;], # identical QHO frequencies in both ground and excited states

                    id =  [sqrt(2);;],  # Equal to HR factor = 1
...
abs_response_function = ensambleDiagram(getAbsResp, Model, parallel = "n", verbose = 1); 
