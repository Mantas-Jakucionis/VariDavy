function getGSB_NR(x0::Vector{ComplexF64}, eVec::Vector{Float64}, tProp::Vector{Float64}, tW::Float64, model::modelStruct)
...
function getESE_NR(x0::Vector{ComplexF64}, eVec::Vector{Float64}, tProp::Vector{Float64}, tW::Float64, model::modelStruct)
...
function getESA_NR(x0::Vector{ComplexF64}, eVec::Vector{Float64}, tProp::Vector{Float64}, tW::Float64, model::modelStruct)
...
function getESE_R(x0::Vector{ComplexF64}, eVec::Vector{Float64}, tProp::Vector{Float64}, tW::Float64, model::modelStruct)
...
function getGSB_R(x0::Vector{ComplexF64}, eVec::Vector{Float64}, tProp::Vector{Float64}, tW::Float64, model::modelStruct)
...
function getESA_R(x0::Vector{ComplexF64}, eVec::Vector{Float64}, tProp::Vector{Float64}, tW::Float64, model::modelStruct)
